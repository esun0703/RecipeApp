                ...
                <div className="container">
		            ...
		            <div className="row">  
		                <div className="col-md-6 leftIndent">
		                    ...
		                    <p>Don't let your delicious food go bad. Keep track of your food expiration dates and see when it's time to create something beautiful.</p>
		                     <a className="btn" href="#/app"><span>VIEW INGREDIENTS</span></a>
		                </div>
		            ...
		            <div className="row">
		                ...
		                <div className="col-md-6">
		                    ...
		                    <a className="btn" href="#/app/recipes"><span>VIEW MENU</span></a>
		                </div>
		            </div>
		            <div className="row">
		                <div className="col-md-6 leftIndent">
		                    ...
		                    <a className="btn" href="#/app/map"><span>DONATE</span></a>
		                </div>
		                <div className="col-md-6">
